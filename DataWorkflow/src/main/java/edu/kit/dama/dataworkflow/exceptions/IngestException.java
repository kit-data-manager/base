 ...
 * @author mf6319
 */
public class IngestException extends DataWorkflowException {
   ...
   */
  public IngestException(String pMessage) {
    super(pMessage);
  }
   ...
   */
  public IngestException(String pMessage, Throwable pCause) {
