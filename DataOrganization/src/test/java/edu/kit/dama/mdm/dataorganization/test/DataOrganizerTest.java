...
public class DataOrganizerTest {
  ...
  DigitalObjectId digitalObjectID
          = new DigitalObjectId("DigitalObjectIdDummy");
  static DataOrganizerImpl dataOrganizer = null;
   ...
   */
  @Test
  public void testSaveAndLoadFileTree() {
  ...
  @Test
  public void testLoadNotExistent() {
  ...
  @Test
  public void testLoadAndSaveWithFileNode() {
