...
public interface IFileTree extends Cloneable {
   ...
   * interpreted in a different way than a normal ICollectionNodes: the name is
   * irrelevant and attributes are of global meaning.
   *
  ...
  /**
   * Walks the tree and executes a pre-order and a post-order action. Should be
   * implemented in means of calling
   * {@link edu.kit.dama.mdm.dataorganization.impl.util.Util#walkSubtree(edu.kit.dama.mdm.dataorganization.entity.core.IDataOrganizationNode, edu.kit.dama.mdm.dataorganization.entity.core.IDataOrganizationNodeVisitor, edu.kit.dama.mdm.dataorganization.entity.core.IDataOrganizationNodeVisitor) }
   * on the root node.
   *
