...
@XmlRootElement
public final class UserIdWrapper extends AbstractEntityWrapper<UserId> {

  @XmlElementWrapper
  @XmlElement(name = "entity")
  private List<UserId> entities;
   ...
   */
  public UserIdWrapper(UserId... pEntities) {
    super(pEntities);
  }
   ...
   */
  public UserIdWrapper(List<UserId> pEntities) {
    super(pEntities);
  }
   ...
   */
  public UserIdWrapper(Integer pCount) {
    super(pCount);
  }

  @Override
  public void setEntities(List<UserId> pEntities) {
    this.entities = pEntities;
  }

  @Override
  public List<UserId> getEntities() {
    return entities;
  }
}
