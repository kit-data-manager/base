...
@XmlRootElement
public final class GrantSetWrapper extends AbstractEntityWrapper<GrantSet> {

  @XmlElementWrapper
  @XmlElement(name = "entity")
  private List<GrantSet> entities;

  /**
   * Default constructor.
   */
  public GrantSetWrapper() {
    super();
  }
   ...
   */
  public GrantSetWrapper(GrantSet... pEntities) {
    super(pEntities);
  }
   ...
   */
  public GrantSetWrapper(List<GrantSet> pEntities) {
    super(pEntities);
  }
   ...
   */
  public GrantSetWrapper(Integer pCount) {
    super(pCount);
  }

  @Override
  public void setEntities(List<GrantSet> pEntities) {
    this.entities = pEntities;
  }

  @Override
  public List<GrantSet> getEntities() {
    return entities;
  }
}
