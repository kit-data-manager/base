...
public interface ISharingService extends ICommonRestInterface {
  ...
  @ReturnType("edu.kit.dama.rest.sharing.types.ReferenceIdWrapper")
  StreamingOutput createReference(
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.sharing.types.GroupIdWrapper")
  StreamingOutput getReferencedGroups(
          @QueryParam("domain") String pDomain,
          @QueryParam("domainUniqueId") String pDomainUniqueId,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.sharing.types.GrantSetWrapper")
  StreamingOutput getGrantSetForResource(
          @QueryParam("domain") String pDomain,
          @QueryParam("domainUniqueId") String pDomainUniqueId,
          @QueryParam("groupId") String pGroupId,
          @javax.ws.rs.core.Context HttpContext hc
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.sharing.types.GrantWrapper")
  StreamingOutput getGrantById(
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.sharing.types.UserIdWrapper")
  StreamingOutput getAuthorizedUsers(
          @QueryParam("domain") String pDomain,
          @QueryParam("domainUniqueId") String pDomainUniqueId,
          @QueryParam("role") String pRole,
          @QueryParam("groupId") String pGroupId,
