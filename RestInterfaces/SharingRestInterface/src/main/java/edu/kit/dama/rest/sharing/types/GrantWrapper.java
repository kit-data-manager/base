...
@XmlRootElement
public final class GrantWrapper extends AbstractEntityWrapper<Grant> {

  @XmlElementWrapper
  @XmlElement(name = "entity")
  private List<Grant> entities;
   ...
   */
  public GrantWrapper(Grant... pEntities) {
    super(pEntities);
  }
   ...
   */
  public GrantWrapper(List<Grant> pEntities) {
    super(pEntities);
  }
   ...
   */
  public GrantWrapper(Integer pCount) {
    super(pCount);
  }

  @Override
  public void setEntities(List<Grant> pEntities) {
    this.entities = pEntities;
  }

  @Override
  public List<Grant> getEntities() {
    return entities;
  }
}
