...
public class BaseMetaDataServiceTest extends JerseyTest {
  ...
  public static void initClient() {
    ...
    BaseMetaDataTestService.factoryDigitalObjectEntity(1l);
    BaseMetaDataTestService.factoryInvestigationEntity(1l);
    BaseMetaDataTestService.factoryMetadataSchemaEntity(1l);
    BaseMetaDataTestService.factoryOrganizationUnitEntity(1l);
    BaseMetaDataTestService.factoryParticipantEntity(1l, 1l);
    BaseMetaDataTestService.factoryRelationEntity(1l, 1l);
    BaseMetaDataTestService.factoryStudyEntity(1l);
    BaseMetaDataTestService.factoryTaskEntity(1l);
    BaseMetaDataTestService.factoryUserDataEntity(1l);
    BaseMetaDataTestService.factoryUserEntity(1l);
  }
  ...
  public void testUpdateOrganizationUnit() {
    OrganizationUnit ou = BaseMetaDataTestService.
            factoryOrganizationUnitEntity(1l);
    ou.setAddress("test1");
    ou.setCity("test2");
    ou.setZipCode("12345");
  ...
  public void testAddRelationToStudy() {
    ...
    assertEquals(1, sw.getWrappedEntities().get(0).getOrganizationUnits().size());
  }
  ...
  public void testAddDigitalObjectType() {
    DigitalObjectTypeWrapper tw = client.addDigitalObjectType(BaseMetaDataTestService.factoryObjectTypeEntity(1l), Constants.USERS_GROUP_ID);
    assertEquals(1, tw.getWrappedEntities().size());
  }
  ...
  public void testGetDigitalObjectTypeById() {
    ...
    assertEquals(1, tw.getWrappedEntities().size());
    assertEquals(1l, tw.getWrappedEntities().get(0).getId());
  }
  ...
  public void testAddDigitalObjectTypeToDigitalObject() {
    DigitalObjectTypeWrapper tw = client.addDigitalObjectTypeToDigitalObject(1l, BaseMetaDataTestService.factoryObjectTypeEntity(1l), Constants.USERS_GROUP_ID);
    assertEquals(1, tw.getWrappedEntities().size());
    assertEquals(1l, tw.getWrappedEntities().get(0).getId());
  }
  ...
  public void testGetDigitalObjectTypeByDigitalObject() {
    DigitalObjectTypeWrapper tw = client.getDigitalObjectTypesByDigitalObject(BaseMetaDataTestService.factoryDigitalObjectEntity(1l), Constants.USERS_GROUP_ID);
    assertEquals(1, tw.getWrappedEntities().size());
    assertEquals(1l, tw.getWrappedEntities().get(0).getId());
  }
  ...
  public void testGetDigitalObjectsByDigitalObjectType() {
    DigitalObjectWrapper ow = client.getDigitalObjectByDigitalObjectType(BaseMetaDataTestService.factoryObjectTypeEntity(1l), Constants.USERS_GROUP_ID);
  ...
  public void testGetDerivationInformation() {
    DigitalObjectTransitionWrapper tw = client.getDigitalObjectDerivationInformation(BaseMetaDataTestService.factoryDigitalObjectEntity(2l), Constants.USERS_GROUP_ID, ctx);
    assertEquals(1, tw.getWrappedEntities().size());
  ...
  public void testGetNoDerivationInformation() {
    DigitalObjectTransitionWrapper tw = client.getDigitalObjectDerivationInformation(BaseMetaDataTestService.factoryDigitalObjectEntity(666l), Constants.USERS_GROUP_ID, ctx);
  ...
  public void testAddTransition() {
    DigitalObjectTransitionWrapper tw = client.addTransitionToDigitalObject(BaseMetaDataTestService.factoryDigitalObjectEntity(1l), BaseMetaDataTestService.factoryDigitalObjectEntity(2l), Constants.USERS_GROUP_ID);
    assertEquals(1, tw.getWrappedEntities().size());
    assertEquals(1l, tw.getEntities().get(0).getId().longValue());
    assertEquals(2l, ((DigitalObject) tw.getEntities().get(0).getOutputObjects().toArray()[0]).getBaseId().longValue());
    assertEquals(1l, ((ObjectViewMapping) tw.getEntities().get(0).getInputObjectViewMappings().toArray()[0]).getDigitalObject().getBaseId().longValue());
  ...
  public void testAddTransitionForInvalidId1() {
    client.addTransitionToDigitalObject(BaseMetaDataTestService.factoryDigitalObjectEntity(666l), BaseMetaDataTestService.factoryDigitalObjectEntity(2l), Constants.USERS_GROUP_ID);
  ...
  public void testAddTransitionForInvalidId2() {
    DigitalObjectTransitionWrapper tw = client.addTransitionToDigitalObject(
            BaseMetaDataTestService.factoryDigitalObjectEntity(1l),
            BaseMetaDataTestService.factoryDigitalObjectEntity(2l),
            Constants.DEFAULT_VIEW,
            BaseMetaDataTestService.factoryDigitalObjectEntity(3l),
            Constants.USERS_GROUP_ID);
