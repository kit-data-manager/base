...
//</editor-fold>
  ...
  /**
   * Path to digital objects for the digital object types with the provided id.
   */
...
//  }
  ...
  /**
   * Get the digital object transition(s) the provided digital object is derived
...
//</editor-fold>
  ...
  /**
   * Update digital object. From the provided digital object only the following
   * attributes are submitted:
   *
   * <ul>
   * <li>label</li>
...
//</editor-fold>
   ...
   * </ul>
   *
   * Experiments are currently not supported. Also a provided digital object id
   * is not submitted but will be generated on the server side.
   *
   * @param pInvestigationId id of the investigation.
   ...
   * @param pOutputObject The output object of this transition. Should be either
   * equal to pObject or to pOtherObject.
   * @param pGroupId id of the group e.g. USERS.
   *
   * @return DigitalObjectTransitionWrapper
   */
  ...
  public DigitalObjectTypeWrapper addDigitalObjectType(
    ...
    returnValue = performDigitalObjectTypePost(DIGITAL_OBJECT_TYPES, queryParams,
            formParams);
    return returnValue;
  }
