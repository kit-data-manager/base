...
@XmlRootElement
public class TaskWrapper extends AbstractEntityWrapper<Task> {
   ...
   */
  public TaskWrapper(Task... pEntities) {
    super(pEntities);
  }
   ...
   */
  public TaskWrapper(List<Task> pEntities) {
    super(pEntities);
  }
   ...
   */
  public TaskWrapper(Integer pCount) {
    super(pCount);
  }

  @Override
  public void setEntities(List<Task> pEntities) {
