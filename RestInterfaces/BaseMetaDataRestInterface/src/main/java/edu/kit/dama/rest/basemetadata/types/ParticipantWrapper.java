...
@XmlRootElement
public class ParticipantWrapper extends AbstractEntityWrapper<Participant> {
   ...
   */
  public ParticipantWrapper(Participant... pEntities) {
    super(pEntities);
  }
   ...
   */
  public ParticipantWrapper(List<Participant> pEntities) {
    super(pEntities);
  }
   ...
   */
  public ParticipantWrapper(Integer pCount) {
    super(pCount);
  }
