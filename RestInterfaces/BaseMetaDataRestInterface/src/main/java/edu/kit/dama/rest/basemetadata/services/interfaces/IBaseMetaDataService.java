...
public interface IBaseMetaDataService extends ICommonRestInterface {
  ...
  /**
   * Get a DigitalObjectTransition by its id. Available transition for an object
   ...
   * attributes.
   *
   * @see edu.kit.dama.rest.basemetadata.types.DigitalObjectTransitionWrapper
   */
  @GET
  @Path(value = "/transitions/{id}")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTransitionWrapper")
  StreamingOutput getDigitalObjectTransitionById(
...
//</editor-fold>
  ...
  /**
   * Returns a list of object types. Without any arguments a call to this method
   * returns the first 10 (or less) object type entries accessible by the
   * calling user.
   *
   ...
   * DigitalObjectTypeWrapper, which removes all attributes but the id from the
   * returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper
   */
  @GET
  @Path(value = "/objectTypes/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput getDigitalObjectTypeIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput getDigitalObjectTypeById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param identifier The domain-unique identifier of the digital object type.
   * @param version The digital object type version if there are multiple
   * versions for the same identifier (default: 1).
   * @param description A human readable description of the digital object type.
   * @param hc The HttpContext for OAuth check.
   *
   * @return The created object type entities. The returned entity is serialized
   * using the <b>default</b> object graph of DigitalObjectTypeWrapper, which
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput addDigitalObjectType(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput getDigitalObjectTypeCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);

  /**
   * Get all digital objects that have the digital object type with the provided
   * id assigned. Currently, neither providing <i>first</i> nor <i>results</i>
   * has any effect. A call to this method always returns all digital objects
   * associated with the provided object type.
   *
   * @summary Get all digital objects that have the digital object type with the
   * provided id assigned.
   *
   * @param groupId The group id the object is associated with. [default: USERS]
   ...
   *
   * @see edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper
   * @TODO Implement first and results parameter handling if required.
   */
  @GET
  @Path(value = "/objectTypes/{id}/digitalObjects")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectsForDigitalObjectType(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectCountForType(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
//</editor-fold>
   ...
   * serialized using the <b>simple</b> object graph of OrganizationUnitWrapper,
   * which removes all attributes but the id from the returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper
   */
  @GET
  @Path(value = "/organizationUnits/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper")
  StreamingOutput getOrganizationUnitIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * <b>default</b> object graph of OrganizationUnitWrapper, which contains all
   * basic fields of the organization unit.
   *
   * @see edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper
   */
  @POST
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper")
  StreamingOutput createOrganizationUnit(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  /**
   * Count all accessible organization units associated with the provided group.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper")
  StreamingOutput getOrganizationUnitCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * object graph of OrganizationUnitWrapper, which contains all basic fields of
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper")
  StreamingOutput getOrganizationUnitById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.OrganizationUnitWrapper")
  StreamingOutput updateOrganizationUnit(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @FormParam("ouName") String ouName,
          @FormParam("address") String address,
...
//</editor-fold>
  ...
  /**
   * Returns a list of accessible metadata schemas. Without any arguments a call
   * to this method returns the first 10 (or less) metadata schema entries
   ...
   * which removes all attributes but the id from the returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.MetadataSchemaWrapper
   */
  @GET
  @Path(value = "/metadataSchemas/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.MetadataSchemaWrapper")
  StreamingOutput getMetadataSchemaIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  /**
   * Create a new metadata schema via POST request. All relevant attributes can
   * be set via form parameters. If a metadata schema was created, the new
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.MetadataSchemaWrapper")
  StreamingOutput createMetadataSchema(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.MetadataSchemaWrapper")
  StreamingOutput getMetadataSchemaCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The metadata schema with the provided id or one of the status codes
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.MetadataSchemaWrapper")
  StreamingOutput getMetadataSchemaById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
//</editor-fold>
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return A list of task entities. All returned entities are serialized using
   * the <b>simple</b> object graph of TaskWrapper, which removes all attributes
   * but the id from the returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.TaskWrapper
   */
  @GET
  @Path(value = "/tasks/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.TaskWrapper")
  StreamingOutput getTaskIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  /**
   * Create a new task via POST request. All relevant attributes can be set via
   * form parameters. If a task was created, the new task is returned.
   *
   * @summary Create a new task.
   *
   * @param groupId The group id this task is associated with.
   * @param taskName The task name. It is recommended to use a unique name here.
   * @param hc The HttpContext for OAuth check.
   *
   * @return The created task entity serialized using the
   * <b>default</b> object graph of TaskWrapper, which contains all basic fields
   * of the task.
   *
   * @see edu.kit.dama.rest.basemetadata.types.TaskWrapper
   */
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The task with the provided id or one of the status codes below. The
   * returned entity is serialized using the <b>default</b>
...
//</editor-fold>
   ...
   * using the <b>simple</b> object graph of UserDataWrapper, which removes all
   * attributes but the id from the returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.UserDataWrapper
   */
  @GET
  @Path(value = "/userData/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.UserDataWrapper")
  StreamingOutput getUserDataIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  /**
   * Count all accessible UserData entities associated with the provided group.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.UserDataWrapper")
  StreamingOutput getUserDataCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The UserData with the provided id or one of the status codes below.
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.UserDataWrapper")
  StreamingOutput getUserDataById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * below. The returned entity is serialized using the <b>default</b>
   * object graph of ParticipantWrapper, which contains all basic fields of the
   * participant.
   *
   * @see edu.kit.dama.rest.basemetadata.types.ParticipantWrapper
   */
  @GET
  @Path(value = "/participants/{id}")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.ParticipantWrapper")
  StreamingOutput getParticipantById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
//</editor-fold>
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The relation with the provided id or one of the status codes below.
   * The returned entity is serialized using the <b>default</b>
   * object graph of RelationWrapper, which contains all basic fields of the
   * relation.
   *
   * @see edu.kit.dama.rest.basemetadata.types.RelationWrapper
   */
  @GET
  @Path(value = "/relations/{id}")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.RelationWrapper")
  StreamingOutput getRelationById(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
...
//</editor-fold>
  ...
  /**
   * Returns a list of accessible studies. Without any arguments a call to this
   * method returns the first 10 (or less) study entries accessible by the
   * calling user in the group USERS.
   *
   ...
   * attributes but the id from the returned entities.
   *
   * @see edu.kit.dama.rest.basemetadata.types.StudyWrapper
   */
  @GET
  @Path(value = "/studies/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.StudyWrapper")
  StreamingOutput getStudyIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  /**
   * Create a new study via POST request. Almost all relevant attributes can be
   * set via form parameters. Only relations are currently not supported at this
   * point. If a study was created, the new study is returned.
   *
   ...
   * fields of the study. Enclosed entities are returned with their id and might
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.StudyWrapper")
  StreamingOutput addRelationToStudy(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
   ...
   *
   * @param groupId The group id the study is associated with. [default: USERS]
   * @param hc The HttpContext for OAuth check.
   *
   * @return The number of accessible studies associated with the provided group
   * wrapped by a StudyWrapper entity.
   *
   * @see edu.kit.dama.rest.basemetadata.types.StudyWrapper
   */
  @GET
   ...
   * The returned entity is serialized using the <b>default</b> object graph of
   * StudyWrapper, which contains all basic fields of the study. Enclosed
   ...
   *
   * @summary Create and add an investigation to the study with the provided id.
   *
   * @param groupId The group id the study is associated with.
   * @param id The id of the study.
   ...
   * @param endDate The end date of the investigation. If no value is provided,
   * no end date will be set.
   * @param hc The HttpContext for OAuth check.
   *
   ...
   * be queried separately.
   *
   * @see edu.kit.dama.rest.basemetadata.types.InvestigationWrapper
   */
  @POST
  @Path(value = "/studies/{id}/investigations/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput addInvestigationToStudy(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @FormParam("topic") String topic,
          @FormParam("note") String note,
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The updated study serialized using the <b>default</b> object graph
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.StudyWrapper")
  StreamingOutput updateStudyById(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @FormParam("topic") String topic,
          @FormParam("note") String note,
...
//</editor-fold>
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput getInvestigationIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  /**
   * Count all accessible investigations associated with the provided group and
   * study.
   *
   * @summary Get the count of all accessible investigations in the provided
   * group and study.
   *
   * @param groupId The group id the investigation is associated with. [default:
   * USERS]
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput getInvestigationCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("studyId") @DefaultValue(Constants.REST_ALL_INT) Long studyId,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput getInvestigationById(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * provided, no start date will be set.
   * @param endDate The end date of the digital object. If no value is provided,
   * no end date will be set.
   * @param hc The HttpContext for OAuth check.
   *
   * @return The added digital object with the provided id or one of the status
   * codes below. The returned entity is serialized using the
   * <b>default</b>
   * object graph of DigitalObjectWrapper, which contains all basic fields of
   * the digital object. Enclosed entities are returned with their id and might
   * be queried separately.
   *
   * @see edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper
   */
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput addDigitalObjectToInvestigation(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput addParticipantToInvestigation(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput addMetadataSchemaToInvestigation(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
  ...
  /**
   * Update the investigation with the provided id. Updates are only allowed for
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.InvestigationWrapper")
  StreamingOutput updateInvestigationById(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @FormParam("topic") String topic,
          @FormParam("note") String note,
   ...
   *
   * @summary Get a list of accessible digital objects, which may be filtered by
   * the group and the investigation they belong to.
   *
   * @param groupId The id of the group the investigation belongs to.
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectIds(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
  ...
  /**
   * Count all accessible digital objects associated with the provided group and
   * investigation.
   *
   ...
   *
   * @param groupId The group id the object is associated with. [default: USERS]
   * @param investigationId The investigation id the object is associated with.
   * @param hc The HttpContext for OAuth check.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("investigationId") @DefaultValue(Constants.REST_ALL_INT) Long investigationId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The digital object with the provided id or one of the status codes
   * below. The returned entity is serialized using the <b>default</b>
   * object graph of DigitalObjectWrapper, which contains all basic fields of
   * the digital object. Enclosed entities are returned with their id and might
   * be queried separately.
   *
   * @see edu.kit.dama.mdm.base.DigitalObject
   */
  @GET
  @Path(value = "/digitalObjects/{id}")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectById(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   *
   * @param digitalObjectId The digital object identifier of the digital object
   * to query for.
   * @param groupId The group id the digital object is associated with.
   * @param hc The HttpContext for OAuth check.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput getDigitalObjectByDOI(
   ...
   *
   * @summary Get the object types assigned to the digital object identified by
   * the provided id.
   *
   * @param groupId The group id the object is associated with. [default: USERS]
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return A list of object types assigned to the object with the provided id.
   * All returned entities are serialized using the <b>simple</b> object graph
   * of DigitalObjectTypeWrapper, which removes all attributes but the id from
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput getDigitalObjectTypesForDigitalObject(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * <b>default</b> object graph of DigitalObjectTypeWrapper, which contains all
   * attributes of the digital object type.
   *
   * @see edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper
   */
  @POST
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTypeWrapper")
  StreamingOutput addDigitalObjectTypeToDigitalObject(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
   ...
   * from. Typically, only one transition should contribute to a digital object,
   * but this may change in future. Transitions returned by this method will
   * have the object with the provided id in their outputObjects list.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTransitionWrapper")
  StreamingOutput getDigitalObjectDerivationInformation(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return All transitions an object contributes to. The result is serialized
   * using the
   * <b>simple</b> object graph of DigitalObjectTransitionWrapper, which
   * contains the id of the transition.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTransitionWrapper")
  StreamingOutput getDigitalObjectContributionInformation(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * output. This can be changed by setting <i>outputId</i> to the same value as
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectTransitionWrapper")
  StreamingOutput addTransitionToDigitalObject(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput addExperimenterToDigitalObject(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @PathParam("id") Long id,
          @FormParam("userDataId") Long userDataId,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.basemetadata.types.DigitalObjectWrapper")
  StreamingOutput updateDigitalObjectById(
          @PathParam("id") Long id,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @FormParam("label") String label,
          @FormParam("note") String note,
  ...
  /**
   * Delete the digital object with the provided id. Currently, deleting digital
