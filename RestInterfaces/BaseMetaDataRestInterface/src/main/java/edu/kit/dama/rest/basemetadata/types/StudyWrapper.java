...
@XmlRootElement
public final class StudyWrapper extends AbstractEntityWrapper<Study> {

  @XmlElementWrapper
  @XmlElement(name = "entity")
  private List<Study> entities;
   ...
   */
  public StudyWrapper(Study... pEntities) {
    super(pEntities);
  }
   ...
   */
  public StudyWrapper(List<Study> pEntities) {
    super(pEntities);
  }
   ...
   */
  public StudyWrapper(Integer pCount) {
    super(pCount);
  }

  @Override
  public void setEntities(List<Study> pEntities) {
    this.entities = pEntities;
  }

  @Override
  public List<Study> getEntities() {
    return entities;
  }
}
