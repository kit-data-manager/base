...
// </editor-fold>
   ...
   * @return UserWrapper.
   */
//  private UserWrapper performUserDelete(String pPath, MultivaluedMap pQueryParams) {
//    return RestClientUtils.performDelete(UserWrapper.class, getWebResource(pPath), pQueryParams);
//  }
  /**
...
//</editor-fold>
   ...
   * pGroupDescription are not checked. If any value is set to null, this value
   * will be stored.
   *
  ...
  /**
   * Update the users first name, last name and e-mail address. Please mind that
   * the provided values pFirstName, pLastName and pEmail are not checked. If
   * any value is set to null, this value will be stored.
   *
...
//</editor-fold>
  //<editor-fold defaultstate="collapsed" desc="remove[UserFromGroup]">
  /**
  ...
  /**
   * Only a small test scenario. The variable 'USER_GROUP_SERVICE' has to be set
   * to 'TestService' to check.
   *
