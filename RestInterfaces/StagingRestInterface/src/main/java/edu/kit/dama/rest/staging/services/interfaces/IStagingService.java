...
public interface IStagingService extends ICommonRestInterface {
  ...
  /**
   * Returns a list of accessible ingests. Without any arguments a call to this
   * method returns the first 10 (or less) ingest entries accessible by the
   * calling user. The list may be filtered by the owner of the ingest, by the
   * digital object id the ingest is associated with or by the integer
   ...
   * status arguments are ignored. If no owner id is provided, the result can be
   * filtered by object id or by status. Available status codes are:<br/>
   *
   * <table>
   ...
   *
   *
   * @summary Get a list of accessible ingests, which may be filtered by owner,
   * digital object id and/or status.
   *
   * @param ownerId The owner id of the ingest. [default: Caller]
   * @param groupId The group id the ingest belongs to [default: USERS]
   * @param objectId The id of the digital object the ingest is associated with.
   * Valid values for this argument are either a digitalObjectIdentifier (unique
   * identifier of a digital object, e.g. efb7aabd-5f35-41fc-8750-90de31b9231e)
   * or the primary key (the database primary key/the base id of the object,
   * e.g. 4711). In future versions this parameter may change to support only
   * the numeric identifier. [default: null/all objects]
   ...
   * IngestInformationWrapper, which removes all attributes but the id from the
   * returned entities.
   *
  ...
  @ReturnType("edu.kit.dama.rest.staging.types.IngestInformationWrapper")
  StreamingOutput getIngestIds(
   ...
   *
   * @param objectId The object id for which an ingest should be created. Valid
   * values for this argument are either a digitalObjectIdentifier (unique
   * identifier of a digital object, e.g. efb7aabd-5f35-41fc-8750-90de31b9231e)
   * or the primary key (the database primary key/the base id of the object,
   * e.g. 4711). In future versions this parameter may change to support only
   * the numeric identifier.
   * @param accessPointId The unique identifier (e.g.
   * 86ad265e-ddf3-45fc-9c2e-c9c5bdb978b2) of the AccessPoint to use to perform
   * this ingest.
   * @param groupId The group id the ingest belongs to [default: USERS]
   * @param hc The HttpContext for OAuth check.
   *
   * @return The created IngestInformation entity serialized using the
   * <b>default</b> object graph of IngestInformation, which contains all basic
   * fields of the ingest information. Enclosed entities are returned with their
   * id and might be queried separately.
   *
   * @see edu.kit.dama.staging.entities.ingest.IngestInformation
   * @see edu.kit.dama.rest.staging.types.IngestInformationWrapper
   */
  ...
  /**
   * Count all accessible ingests. The result can be filtered by owner id and/or
   * by ingest status. If no owner id is provided, the number of ingests
   * accessible by the caller of this method will be returned. If no status is
   * provided, ingests with all status codes are returned. Available status
   * codes are:<br/>
   *
   * <table>
   * <tr><th>Enum</th><th>Value</th></tr>
  ...
  @Produces("application/xml")
  StreamingOutput getIngestsCount(
          @QueryParam("ownerId") String ownerId,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("status") @DefaultValue(Constants.REST_ALL_INT) Integer status,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * IngestInformationWrapper, which contains all basic fields of the ingest
   * information. Enclosed entities are returned with their id and might be
   * queried separately.
   *
   * @see edu.kit.dama.staging.entities.ingest.IngestInformation
   * @see edu.kit.dama.rest.staging.types.IngestInformationWrapper
   ...
   * data handling. Available status codes are:<br/>
   *
   * <table>
   * <tr><th>Enum</th><th>Value</th></tr>
   * <tr><td>UNKNOWN</td><td>0</td></tr>
   ...
   *
   * @see edu.kit.dama.rest.staging.entities.ingest.IngestInformation
   * @see edu.​kit.​dama.​staging.​entities.​ingest.INGEST_STATUS
   */
  @PUT
  @Path(value = "/ingests/{id}")
   ...
   * method returns the first 10 (or less) expired ingest entries accessible by
   * the calling user in the provided groupF.
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.IngestInformationWrapper")
  StreamingOutput getExpiredIngests(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
          @javax.ws.rs.core.Context HttpContext hc);
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.IngestInformationWrapper")
  StreamingOutput getExpiredIngestsCount(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * the calling user. The list may be filtered by the owner of the download, by
   * the digital object id the download is associated with and by the integer
   * representation of the download's status. Available status codes are:<br/>
   *
   * <table>
   * <tr><th>Enum</th><th>Value</th></tr>
   * <tr><td>UNKNOWN</td><td>0</td></tr>
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput getDownloadIds(
          @QueryParam("ownerId") String ownerId,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("objectId") String objectId,
          @QueryParam("status") @DefaultValue(Constants.REST_ALL_INT) Integer status,
   ...
   * definition only allows to set the digital object id of the download and the
   * unique identifier of the AccessPoint to use. Currently, there is no way to
   * select parts of a digital object to download.
   *
   * @summary Create a new download entity.
   *
   * @param groupId The group the download belongs to. [default: USERS]
   * @param objectId The object id for which a download should be created. Valid
   * values for this argument are either a digitalObjectIdentifier (unique
   * identifier of a digital object, e.g. efb7aabd-5f35-41fc-8750-90de31b9231e)
   * or the primary key (the database primary key/the base id of the object,
   * e.g. 4711). In future versions this parameter may change to support only
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput createDownload(
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @FormParam("objectId") String objectId,
          @FormParam("accessPoint") String accessPointId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * status is provided, downloads with all status codes are returned. Available
   * status codes are:<br/>
   *
   * <table>
   * <tr><th>Enum</th><th>Value</th></tr>
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput getDownloadsCount(
          @QueryParam("ownerId") String ownerId,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("status") @DefaultValue(Constants.REST_ALL_INT) Integer status,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   * @param hc The HttpContext for OAuth check.
   *
   * @return The download with the provided id or one of the status codes below.
   * The returned entity is serialized using the <b>default</b> object graph of
   * DownloadInformation, which contains all basic fields of the download
   * information. Enclosed entities are returned with their id and might be
   * queried separately.
   *
   * @see edu.kit.dama.staging.entities.download.DownloadInformation
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput getDownloadById(
          @PathParam("id") Long id,
          @javax.ws.rs.core.Context HttpContext hc);

  /**
   * Update the download with the provided id. Updates are only allowed for some
   * fields as most attributes are set internally and influence workflows and
   * data handling. Available status codes are:<br/>
   *
   * <table>
   ...
   *
   * @see edu.kit.dama.rest.staging.entities.download.DownloadInformation
   * @see edu.​kit.​dama.​staging.​entities.​download.DOWNLOAD_STATUS
   */
  @PUT
  @Path(value = "/downloads/{id}")
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput getExpiredDownloads(
          @QueryParam("ownerId") String ownerId,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @QueryParam("first") @DefaultValue(Constants.REST_DEFAULT_MIN_INDEX) Integer first,
          @QueryParam("results") @DefaultValue(Constants.REST_DEFAULT_MAX_RESULTS) Integer results,
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.DownloadInformationWrapper")
  StreamingOutput getExpiredDownloadsCount(
          @QueryParam("ownerId") String ownerId,
          @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String groupId,
          @javax.ws.rs.core.Context HttpContext hc);
   ...
   *
   * @summary Get the transfer container for the download with the provided id.
   *
   ...
   *
   * @see edu.​kit.​dama.​staging.​entities.TransferTaskContainer
   */
  @GET
  @Path(value = "/downloads/container/{id}")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.TransferTaskContainer")
  StreamingOutput getDownloadContainer(@PathParam("id") Long pId, @javax.ws.rs.core.Context HttpContext hc);
   ...
   * their unique identifier. If a groupId is provided, all access points usable
   * by this group are returned. If a unique identifier is provided, the access
   * point with this identifier is returned or nothing, if no access point
   * exists for this identifier. If both, unique identifier and groupId are
   * provided, the access point with the identifier usable by the group or
   * nothing are returned.
   *
   * @summary Get a list of usable access points.
   *
   * @param pUniqueIdentifier The unique identifier of an access point. If this
   * argument is provided, one or no result are returned.
   * @param pGroupId The id of the group to which the access points belong. This
   * argument should never be null. If no groupId is provided, the id of the
   * default group USERS will be used.
   * @param hc The HttpContext for OAuth check.
   *
   ...
   *
   * @see edu.kit.dama.rest.staging.types.StagingAccessPointConfigurationWrapper
   */
  @GET
  @Path(value = "/accesspoints/")
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.StagingAccessPointConfigurationWrapper")
  StreamingOutput getStagingAccessPoints(@QueryParam("uniqueIdentifier") String pUniqueIdentifier, @QueryParam("groupId") @DefaultValue(Constants.USERS_GROUP_ID) String pGroupId, @javax.ws.rs.core.Context HttpContext hc);

  /**
   * Get the staging access point configuration for the provided id. If no
   * access point configuration for this id exists, an empty result is returned.
   *
   *
  ...
  @Produces("application/xml")
  @ReturnType("edu.kit.dama.rest.staging.types.StagingAccessPointConfigurationWrapper")
  StreamingOutput getStagingAccessPoint(@PathParam("id") Long pId, @javax.ws.rs.core.Context HttpContext hc);
