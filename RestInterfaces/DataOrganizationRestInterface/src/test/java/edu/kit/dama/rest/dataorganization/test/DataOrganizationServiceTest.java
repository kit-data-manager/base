...
public class DataOrganizationServiceTest extends JerseyTest {
    ...
    public static void initClient() {
        client = new DataOrganizationRestClient(
                "http://localhost:9998/DataOrganizationTest",
    ...
    public void testRootNode() {
        ...
        assertEquals(ni.getNodeId(), Long.valueOf(100l));
    }
    ...
    public void testChildren() {
        DataOrganizationNodeWrapper nw = client.getChildren(null, 1l, 100l, 0, Integer.MAX_VALUE, null);

        DataOrganizationNodeWrapper nw2 = client.getChildCount(null, 1l, 100l, null);
        assertEquals((long) nw.getCount(), 2l);
