...
public class FilteredComboBox<T> extends CustomComponent implements
     ...
     * @param property The property holding the data for display.
     */
    public void initializeComboBox(String caption, BeanItemContainer<T> bic, String property) {
    ...
    /**
     * Add a method to add new entries. This method should be called only once
     * per instance.
     *
    ...
    public void addListener(ValueChangeListener vcl) {
        comboBox.addValueChangeListener(vcl);
    }
    ...
    public void removeListener(ValueChangeListener vcl) {
        comboBox.removeValueChangeListener(vcl);
    }
    ...
    public void valueChange(ValueChangeEvent event) {
        Property selected = beanItems.getContainerProperty(event.getProperty().getValue(), property);
        if (debugMode) {
