...
public class IconContainer {
    ...
    public final static String GROUPS = "img/users1.png";
    public final static String USERS = "img/users3.png";
    public final static String USER_NEW = "img/user1_new.png";
    public final static String VIEW = "img/view.png";
    public final static String TEXT_CODE_JAVA_INPUT = "img/text_code_java_input.png";
    ...
    public final static String FOLDER_OK = "img/folder_ok.png";
}
