 ...
 * @author dx6468
 */
public class MembershipsContainer extends BeanItemContainer<Membership> {
    ...
    public static final String[] COLUMN_HEADERS = new String[]{
        ...
        Property.ROLE.columnHeader
    };

    public MembershipsContainer() {
        super(Membership.class);
        addNestedContainerProperty(Property.GROUP_ID.propertyId);
    }
