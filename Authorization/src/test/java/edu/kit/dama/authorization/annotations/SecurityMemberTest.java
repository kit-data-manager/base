...
public class SecurityMemberTest extends SecurityUtil {

  /**
   * For logging purposes.
   */
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityMemberTest.class);
     ...
     * @param success
     */
    public SecurityMemberTest(Role resourceUserRole, Role resourceGroupRole, UserId userId, GroupId groupId, Role userRole, Boolean success) {
