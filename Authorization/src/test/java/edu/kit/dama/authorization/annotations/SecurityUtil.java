...
public class SecurityUtil {
  ...
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityUtil.class);
     ...
     *
     */
    public static final IAuthorizationContext adminContext = new AuthorizationContext(new UserId(Constants.SYSTEM_ADMIN), new GroupId(Constants.SYSTEM_GROUP), Role.ADMINISTRATOR);
  ...
  private static void addUsers2Group(GroupId group, Role maxRole, UserId manager, UserId... members) {
    try {
      ...
      java.util.logging.Logger.getLogger(SecurityGuestTest.class.getName()).log(Level.SEVERE, null, ex);
    } catch (EntityAlreadyExistsException ex) {
      java.util.logging.Logger.getLogger(SecurityGuestTest.class.getName()).log(Level.SEVERE, null, ex);
    } catch (UnauthorizedAccessAttemptException ex) {
      java.util.logging.Logger.getLogger(SecurityGuestTest.class.getName()).log(Level.SEVERE, null, ex);
  ...
  @SecuredMethod
  void securedMethod_default(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_default");
  }

  @SecuredMethod(roleRequired = Role.NO_ACCESS)
  void securedMethod_noAccess(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_noAccess");
  }

  @SecuredMethod(roleRequired = Role.GUEST)
  void securedMethod_guest(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_guest");
  }

  @SecuredMethod(roleRequired = Role.MEMBER)
  void securedMethod_member(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_member");
  }

  @SecuredMethod(roleRequired = Role.MANAGER)
  void securedMethod_manager(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_manager");
  }

  @SecuredMethod(roleRequired = Role.ADMINISTRATOR)
  void securedMethod_admin(@Context IAuthorizationContext ctx, int dummy) throws UnauthorizedAccessAttemptException {
    System.out.println("secMethod_admin");
  }
  // </editor-fold>

  // <editor-fold defaultstate="collapsed" desc="Secure Methods with SecureArguments">
  @SecuredMethod
  void securedMethodPersist_default(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_default");
  }

  @SecuredMethod(roleRequired = Role.NO_ACCESS)
  void securedMethodPersist_noAccess(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_noAccess");
  }

  @SecuredMethod(roleRequired = Role.GUEST)
  void securedMethodPersist_guest(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_guest");
  }

  @SecuredMethod(roleRequired = Role.MEMBER)
  void securedMethodPersist_member(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_member");
  }

  @SecuredMethod(roleRequired = Role.MANAGER)
  void securedMethodPersist_manager(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_manager");
  }

  @SecuredMethod(roleRequired = Role.ADMINISTRATOR)
  void securedMethodPersist_admin(@Context IAuthorizationContext ctx, @SecuredArgument SecurityTestEntity dummy) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
    System.out.println("secMethod_admin");
  }
  // </editor-fold>
}
