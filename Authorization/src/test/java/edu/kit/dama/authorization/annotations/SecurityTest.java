...
public class SecurityTest extends SecurityUtil {
  ...
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityGuestTest.class);
     ...
     * @param success
     */
    public SecurityTest(Role resourceUserRole, Role resourceGroupRole, UserId userId, GroupId groupId, Role userRole, Boolean success) {
