...
public class SecurityAdminTest extends SecurityUtil {

  /**
   * For logging purposes.
   */
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityAdminTest.class);
     ...
     * @param success
     */
    public SecurityAdminTest(Role resourceUserRole, Role resourceGroupRole, UserId userId, GroupId groupId, Role userRole, Boolean success) {
