...
public class SecurityGuestTest extends SecurityUtil {
  ...
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityGuestTest.class);
     ...
     * @param success
     */
    public SecurityGuestTest(Role resourceUserRole, Role resourceGroupRole, UserId userId, GroupId groupId, Role userRole, Boolean success) {
