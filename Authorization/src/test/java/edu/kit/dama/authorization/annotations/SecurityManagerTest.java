...
public class SecurityManagerTest extends SecurityUtil {
  ...
  private static Logger LOGGER = LoggerFactory.getLogger(SecurityManagerTest.class);
     ...
     * @param success
     */
    public SecurityManagerTest(Role resourceUserRole, Role resourceGroupRole, UserId userId, GroupId groupId, Role userRole, Boolean success) {
