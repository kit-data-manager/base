...
CREATE TABLE testentity (
    id integer NOT NULL DEFAULT nextval('testentity_id_seq'),
    summary character varying(255),
    description character varying(255),
    CONSTRAINT testentity_pkey PRIMARY KEY (id)
);

CREATE SEQUENCE securitytestentity_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE;

CREATE TABLE securitytestentity (
    id integer NOT NULL DEFAULT nextval('securitytestentity_id_seq'),
    summary character varying(255),
    description character varying(255),
    anyValue integer,
    CONSTRAINT securitytestentity_pkey PRIMARY KEY (id)
);
SHUTDOWN