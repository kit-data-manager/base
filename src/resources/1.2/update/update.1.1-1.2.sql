-- Fix typo in ExecutionEnvironmentConfiguration table
ALTER TABLE ExecutionEnvironmentConfiguration RENAME COLUMN decription TO description;

-- Add unique identifier column
ALTER TABLE ExecutionEnvironmentConfiguration ADD COLUMN uniqueidentifier character varying(255) NOT NULL;

-- Fix refactoring issue of LFNImpl class
