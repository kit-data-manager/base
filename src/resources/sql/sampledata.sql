...
INSERT INTO users VALUES (nextval('users_id_seq'), 12, 'admin'); -- id 1
-- Link user WORLD to Authorization users table
INSERT INTO users VALUES (nextval('users_id_seq'), 3, 'WORLD'); -- id 2
-- Link OAI-PMH user to Authorization users table
INSERT INTO users VALUES (nextval('users_id_seq'), 3, 'OAI-PMH'); -- id 3

-- Add default group with unique identifier 'USERS' and 'WORLD'
INSERT INTO groups VALUES (nextval('groups_id_seq'), 'USERS');-- id 1
INSERT INTO groups VALUES (nextval('groups_id_seq'), 'WORLD');-- id 2

-- Link Authorization group to metadata group table
INSERT INTO usergroup VALUES (nextval('usergroup_id_seq'), 'Default group containing all users.', 'USERS', 'All Users'); -- id 1
INSERT INTO usergroup VALUES (nextval('usergroup_id_seq'), 'Anonymous group.', 'WORLD', 'Anonymous group'); -- id 2

-- Add membership for user 1 (admin) in group 1 (USERS) with role 12 (Administrator)
INSERT INTO memberships(id, membersrole, group_id, user_id) VALUES (nextval('memberships_id_seq'), 12, 1, 1);
-- Add membership for user 2 (WORLD) in group 1 (USERS) with role 3 (Guest)
INSERT INTO memberships(id, membersrole, group_id, user_id) VALUES (nextval('memberships_id_seq'), 3, 1, 2);
-- Add membership for user 2 (WORLD) in group 2 (WORLD) with role 3 (Guest)
INSERT INTO memberships(id, membersrole, group_id, user_id) VALUES (nextval('memberships_id_seq'), 3, 2, 2);

-- Add membership for user 2 (OAI-PMH) in group 2 (WORLD) with role 3 (Guest)
INSERT INTO memberships(id, membersrole, group_id, user_id) VALUES (nextval('memberships_id_seq'), 3, 2, 3);
...
--INSERT INTO stagingaccesspointconfiguration VALUES (nextval('stagingaccesspointconfiguration_id_seq'), NULL, TRUE, NULL, FALSE, NULL, 'edu.kit.dama.staging.ap.impl.BasicStagingAccessPoint', '/var/lib/tomcat7/webapps/webdav/', 'WebDav', 'http://ipelsdf1.lsdf.kit.edu:8889/webdav/', FALSE, '0000-0000-0000-0000');
