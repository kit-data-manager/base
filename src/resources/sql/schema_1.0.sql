...
-- Started on 2014-11-06 13:55:11
...
ALTER TABLE public.dataorganizationnode OWNER TO postgres;
...
ALTER TABLE public.digitalobject OWNER TO postgres;
...
ALTER TABLE public.digitalobject_baseid_seq OWNER TO postgres;
...
ALTER TABLE public.digitalobject_userdata OWNER TO postgres;
...
ALTER TABLE public.downloadinformation OWNER TO postgres;
...
ALTER TABLE public.grantsets OWNER TO postgres;
...
ALTER TABLE public.resourcereferences OWNER TO postgres;
...
ALTER TABLE public.filterhelper_hack OWNER TO postgres;
...
ALTER TABLE public.filterhelper OWNER TO postgres;
...
ALTER TABLE public.grantsets_id_seq OWNER TO postgres;
...
ALTER TABLE public.ingestinformation OWNER TO postgres;
...
ALTER TABLE public.ingestinformation_stagingprocessor OWNER TO postgres;
...
ALTER TABLE public.investigation_investigationid_seq OWNER TO postgres;
...
ALTER TABLE public.investigation_metadataschema OWNER TO postgres;
...
ALTER TABLE public.investigation_participant OWNER TO postgres;
...
ALTER TABLE public.metadataindexingtask OWNER TO postgres;
...
ALTER TABLE public.metadataindexingtask_id_seq OWNER TO postgres;
...
ALTER TABLE public.metadataschema OWNER TO postgres;
...
ALTER TABLE public.metadataschema_id_seq OWNER TO postgres;
...
ALTER TABLE public.organizationunit_organizationunitid_seq OWNER TO postgres;
...
ALTER TABLE public.participant_participantid_seq OWNER TO postgres;
...
ALTER TABLE public.publicationentry OWNER TO postgres;
...
ALTER TABLE public.publicationentry_id_seq OWNER TO postgres;
...
ALTER TABLE public.resourcereferences_id_seq OWNER TO postgres;
...
ALTER TABLE public.serviceaccesstoken OWNER TO postgres;
...
ALTER TABLE public.serviceaccesstoken_id_seq OWNER TO postgres;
...
ALTER TABLE public.stagingaccesspointconfiguration OWNER TO postgres;
...
ALTER TABLE public.stagingaccesspointconfiguration_id_seq OWNER TO postgres;
...
ALTER TABLE public.stagingaccessproviderconfiguration OWNER TO postgres;
...
ALTER TABLE public.stagingaccessproviderconfiguration_id_seq OWNER TO postgres;
...
ALTER TABLE public.stagingprocessor OWNER TO postgres;
...
ALTER TABLE public.stagingprocessor_id_seq OWNER TO postgres;
...
ALTER TABLE public.study_relation OWNER TO postgres;
...
ALTER TABLE public.study_studyid_seq OWNER TO postgres;
...
ALTER TABLE public.userproperty_id_seq OWNER TO postgres;
...
ALTER TABLE public.userpropertycollection OWNER TO postgres;
...
ALTER TABLE public.userpropertycollection_id_seq OWNER TO postgres;
...
ALTER TABLE public.userpropertycollection_userproperty OWNER TO postgres;
