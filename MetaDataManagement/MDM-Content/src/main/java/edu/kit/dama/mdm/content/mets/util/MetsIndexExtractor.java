...
/**
 * <p>Base class for extractor plugins.</p>
 *
 ...
 * @author hartmann-v
 */
public abstract class MetsIndexExtractor implements IMetsTypeExtractor {
  
  private List<Namespace> allNamespaces = new ArrayList<>();
  
  protected MetsIndexExtractor() {
   ...
   * have to be added via this method.
   * Default namespaces:
   * - mets
   * - 
