 ...
 */
package edu.kit.dama.mdm.content.oaipmh.util;
...
public class OAIPMHBuilder {
    ...
    public OAIPMHBuilder addMetadataFormat(String prefix, String namespace, String schema) {
        if (isError()) {
            return this;
        }
        switch (verb) {
            case LIST_METADATA_FORMATS:
                ...
                format.setMetadataPrefix(prefix);
                format.setMetadataNamespace(namespace);
