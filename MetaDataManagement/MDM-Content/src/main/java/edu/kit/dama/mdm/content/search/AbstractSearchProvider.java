...
public abstract class AbstractSearchProvider<C> {
     ...
     * method first performs {@link #queryForResults(java.util.List)} and then
     * may filter the obtained results using
     *  {@link #filterResults(java.util.List, edu.kit.dama.authorization.entities.IAuthorizationContext) }
    ...
    /**
     * The actual search action implemented by the concrete search provider.
     * This search returns all results that fit the provided search terms. The
     * results might be filtered later using
     *  {@link #filterResults(java.util.List, edu.kit.dama.authorization.entities.IAuthorizationContext) }
     *
     * @param pTermValues A list of search terms including their values.
     *
