...
public final class SharingRestServiceImpl implements ISharingService {
  ...
  @Override
  public StreamingOutput createReference(String pDomain, String pDomainUniqueId, String pReferenceGroupId, String pRole, String pGroupId, HttpContext hc) {
    ...
    try {
      ...
      return createObjectGraphStream(ReferenceIdWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new ReferenceIdWrapper(refId));
  ...
  @Override
  public StreamingOutput getReferences(String pDomain, String pDomainUniqueId, String pGroupId, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    SecurableResourceId resId = factoryResourceId(pDomain, pDomainUniqueId);
    try {
      List<ReferenceId> references = ResourceServiceLocal.getSingleton().getReferences(resId, ctx);
      return createObjectGraphStream(ReferenceIdWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new ReferenceIdWrapper(references));
    } catch (UnauthorizedAccessAttemptException ex) {
  ...
  @Override
  public StreamingOutput getReferencedGroups(String pDomain, String pDomainUniqueId, String pRole, String pGroupId, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    SecurableResourceId resId = factoryResourceId(pDomain, pDomainUniqueId);
    try {
      LOGGER.debug("Try to obtain groups referencing resource {} with at least role {}", resId, pRole);
      List<GroupId> groups = ResourceServiceLocal.getSingleton().getAuthorizedGroups(resId, Role.valueOf(pRole), ctx);
      return createObjectGraphStream(GroupIdWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new GroupIdWrapper(groups));
    } catch (UnauthorizedAccessAttemptException ex) {
  ...
  @Override
  public StreamingOutput getGrantSetForResource(String pDomain, String pDomainUniqueId, String pGroupId, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    SecurableResourceId resId = factoryResourceId(pDomain, pDomainUniqueId);
    try {
      ...
      return createObjectGraphStream(GrantSetWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new GrantSetWrapper(grantSet));
    } catch (UnauthorizedAccessAttemptException ex) {
  ...
  @Override
  public StreamingOutput getGrantById(Long pId, String pGroupId, HttpContext hc) {
    ...
    try {
      ...
      return createObjectGraphStream(GrantWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new GrantWrapper(grant));
    } catch (EntityNotFoundException ex) {
  ...
  @Override
  public StreamingOutput createGrant(String pDomain, String pDomainUniqueId, final String pUserId, String pGroupId, String pRole, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    try {
      SecurableResourceId resId = factoryResourceId(pDomain, pDomainUniqueId);
  ...
  @Override
  public StreamingOutput updateGrant(Long pId, String pGroupId, String pRole, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    //Hack using EM directly...other way?
    EntityManager em = PU.entityManager();
    try {
  ...
  @Override
  public StreamingOutput getAuthorizedUsers(String pDomain, String pDomainUniqueId, String pRole, String pGroupId, HttpContext hc) {
    IAuthorizationContext ctx = RestUtils.authorize(hc, new GroupId(pGroupId));
    SecurableResourceId resId = factoryResourceId(pDomain, pDomainUniqueId);
    try {
      List<UserId> users = ResourceServiceLocal.getSingleton().getAuthorizedUsers(resId, Role.valueOf(pRole), ctx);
      return createObjectGraphStream(UserIdWrapper.class, Constants.REST_DEFAULT_OBJECT_GRAPH, new UserIdWrapper(users));
    } catch (UnauthorizedAccessAttemptException ex) {
