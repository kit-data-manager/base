...
public final class TypeResolver {
   ...
   *
   * @return type argument for {@code initialType} else {@code null} if no type
  ...
  /**
   * Resolves the type argument for the {@code genericType} using type variable
   * information from the {@code sourceType}. If {@code genericType} is an
   * instance of class, then {@code genericType} is returned. If no arguments
   ...
   * {@code targetType} resolved upwards from the {@code initialType}. Arguments
   * for {@code targetType} that cannot be resolved to a Class are returned as
   ...
   * {@code initialType} else {@code null} if no type arguments are declared
   */
  ...
  /**
   * Resolves the arguments for the {@code genericType} using the type variable
   * information for the {@code targetType}. Returns {@code null} if
  ...
  public static Type resolveGenericType(Type initialType, Class<?> targetType) {
    ...
    if (targetType.isInterface()) {
      for (Type superInterface : rawType.getGenericInterfaces()) {
        if (superInterface != null && !superInterface.equals(Object.class) && (result = resolveGenericType(superInterface, targetType)) != null) {
          return result;
        }
      }
    }
    ...
    if (superType != null && !superType.equals(Object.class) && (result = resolveGenericType(superType, targetType)) != null) {
      return result;
    }
   ...
   * @param map The type variable map.
   */
