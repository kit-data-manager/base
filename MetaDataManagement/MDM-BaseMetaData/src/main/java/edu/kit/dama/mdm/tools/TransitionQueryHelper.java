...
public final class TransitionQueryHelper {
   ...
   *
   * @param pInputObject The input object.
   * @param pTransitionImplementationClass The transition implementation class.
   * @param pContext The context used to authorize the access.
   *
   * @return A list of transitions of type pTransitionImplementationClass where
   * pInputObject is in the map of input objects.
   *
   * @throws UnauthorizedAccessAttemptException if pContext is not authorized to
   * perform the query.
   */
   ...
   * @param pContext The context used to authorize the access.
   *
   * @return A list of transitions where pOutputObject is in the list of output
   * objects.
   *
   * @throws UnauthorizedAccessAttemptException if pContext is not authorized to
   * perform the query.
   ...
   *
   * @return A list of transitions of type pTransitionImplementationClass where
   * pOutputObject is in the list of outputobjects.
   *
   * @throws UnauthorizedAccessAttemptException if pContext is not authorized to
   * perform the query.
   */
  ...
  /**
   * Remove all transitions where pObject is input or output. This method should
   * only be necessary if pObject is also removed.
   *
