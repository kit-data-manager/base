...
public final class DigitalObjectSecureQueryHelper extends AbstractSecureQueryHelper<DigitalObject> {
   ...
   * @param pDefailedQuery A detailed query string or null if no detailed query
   * is needed.
   ...
   * allowed to access this method or any digital object in the provided study.
   */
   ...
   * Otherwise, max. pMaxResult objects of pInvestigation will be in the result
   * list.
   *
   * @param pStudy The study where the objects belong to.
   * @param pInvestigation The investigation where the objects belong to.
   * @param pDetailedQuery A detailed query string or null if no detailed query
   * is needed.
  ...
  /**
   * Get the number of readable digital objects in the provided investigation or
   * study. If pInvestigation is 'null', all objects in pStudy are returned.
   * Otherwise, max. pMaxResult objects of pInvestigation will be in the result
   * list.
   *
  ...
  /*@SecuredMethod(roleRequired = Role.GUEST)
   ...
   List<DigitalObject> result = getReadableResources(pMetaDataManager, "o.digitalObjectIdentifier='" + pDigitalObjectId + "'", 0, 1, pContext);
   if (result.isEmpty()) {
   ...
   * @throws UnauthorizedAccessAttemptException If the provided context is not
   * allowed to access this method or any digital object.
   * @throws EntityNotFoundException If no object was found during the query for
   * securable resources.
   */
  @SecuredMethod(roleRequired = Role.GUEST)
  public DigitalObject getObjectByIdentifier(String pDigitalObjectId, IMetaDataManager pMetaDataManager, @Context IAuthorizationContext pContext) throws UnauthorizedAccessAttemptException, EntityNotFoundException {
  ...
  /**
   * Perform a quick check whether a digital object for the provided identifier
   * exists. The check includes a query for the according securable resource
   * followed by a query for count of digital objects for the provided
   * identifier. If this count is not 0, 'TRUE' is returned.
   *
   * @param pDigitalObjectId The digital object id.
   * @param pMetaDataManager The MetaDataManager used to perform the query.
   * @param pContext The security context.
