...
public class UserData implements Serializable {
   ...
   * the user administration domain used by the underlaying system. E.g. an LDAP
   * server, a Web portal or a Shibboleth federation.
   */
  ...
  /**
   * The full user name (LastName, FirstName) used for presentation withing UIs.
   */
  @Transient
  @XmlTransient
  ...
  /**
   * The id of the group the user is currently working in. By default, USERS is
   * the current group.
   */
  @Transient
  @XmlTransient
  ...
  /**
   * Set property 'validUntil'. If validUntil is less or equal than validFrom an
  ...
  /**
   * Set property 'validFrom'. If validFrom is greater or equal than validUntil
  ...
  /**
   * Returns the role which was determined for this user. If no current role is
   * defined, the default role will be returned. The current role is reset if
...
// </editor-fold>
   ...
   * instead of using 'null'. The userId of the user will be 'NoUser', the id is
   * 0 and first name, last name and email are set to 'No', 'User' and 'NoUser'.
   *
