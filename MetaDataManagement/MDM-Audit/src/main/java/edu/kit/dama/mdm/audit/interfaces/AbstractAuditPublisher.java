 ...
 * @author jejkal
 */
public abstract class AbstractAuditPublisher implements IConfigurableAdapter {

    /**
     * Default constructor.
     */
    public AbstractAuditPublisher() {
    }
    ...
    public abstract void publish(AuditEvent entry);
