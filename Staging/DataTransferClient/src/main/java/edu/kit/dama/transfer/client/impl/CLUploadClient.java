 ...
 * @author jejkal
 */
public class CLUploadClient extends BaseUserClient implements ITransferTaskListener, ITransferStatusListener, Thread.UncaughtExceptionHandler {

  /**
   * The Logger
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(CLUploadClient.class);
   ...
   */
  public CLUploadClient(String[] pArgs) throws TransferClientInstatiationException, CommandLineHelpOnlyException {
    addOption(LOCAL, "The local source directory which contains the data to upload.", 1, "localSource", true);
    configure(pArgs);
    ...
    addTransferTaskListener(CLUploadClient.this);
    addTransferStatusListener(CLUploadClient.this);
