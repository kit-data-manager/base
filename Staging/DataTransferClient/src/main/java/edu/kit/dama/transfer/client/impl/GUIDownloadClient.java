...
public class GUIDownloadClient extends BaseUserClient implements Thread.UncaughtExceptionHandler {
   ...
   * The logger
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(GUIDownloadClient.class);
  /**
   ...
   */
  public GUIDownloadClient(String[] pArgs) throws TransferClientInstatiationException, CommandLineHelpOnlyException {
    super();
    configure(pArgs);
