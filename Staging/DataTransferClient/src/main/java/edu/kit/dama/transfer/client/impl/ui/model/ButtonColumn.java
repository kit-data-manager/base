...
public class ButtonColumn extends AbstractCellEditor
  ...
  public ButtonColumn(JTable table, Action action, int column) {
    ...
    columnModel.getColumn(column).setCellRenderer(ButtonColumn.this);
    columnModel.getColumn(column).setCellEditor(ButtonColumn.this);
    table.addMouseListener(ButtonColumn.this);
  }
