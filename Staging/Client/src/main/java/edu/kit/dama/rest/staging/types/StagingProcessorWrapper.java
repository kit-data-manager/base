...
@XmlRootElement
public class StagingProcessorWrapper extends AbstractEntityWrapper<StagingProcessor> {
    ...
    private List<StagingProcessor> entities;

    /**
     * Default constructor.
     */
    public StagingProcessorWrapper() {
        super();
    }
     ...
     */
    public StagingProcessorWrapper(List<StagingProcessor> pEntities) {
        super(pEntities);
    }
     ...
     */
    public StagingProcessorWrapper(StagingProcessor... pEntities) {
        super(pEntities);
    }
     ...
     */
    public StagingProcessorWrapper(Integer pCount) {
        super(pCount);
    }

    @Override
    public final void setEntities(List<StagingProcessor> pEntities) {
        this.entities = pEntities;
    }

    @Override
    public final List<StagingProcessor> getEntities() {
        return entities;
    }
}
