 ...
 * The empty constructor is only available for reasons of bean-compliance. <br/>
 ...
 *
 * @see DownloadInformationPersistenceImpl
 * @author jejkal
 */
...
@XmlRootElement
//</editor-fold>
public class DownloadInformation implements ITransferInformation<DOWNLOAD_STATUS>, Serializable {
  ...
  /**
   * The id of the access provider used to perform this download.
   */
