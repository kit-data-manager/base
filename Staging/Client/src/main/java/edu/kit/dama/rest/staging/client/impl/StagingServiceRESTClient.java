...
public class StagingServiceRESTClient extends AbstractRestClient {
 ...
 //</editor-fold>
   ...
   * AccessPoints by id.
   */
  public static final String STAGING_ALL_ACCESS_POINTS_BY_ID = STAGING_ALL_ACCESS_POINTS + "/{0}";
  /**
...
// </editor-fold>
  ...
  //</editor-fold>
  // <editor-fold defaultstate="collapsed" desc="getAll[Ingests|Downloads|AccessPoints]">
  /**
   * Get all ingests.
   *
   ...
   *
   * @param pOwnerId id of owner (null if not relevant)
   * @param pGroupId of owner group (null if not relevant)
   * @param pObjectId id of object (null if not relevant)
   * @param pStatus status of ingest service.
   * @param pFirstIndex index of first result
   * @param pResults no of results
   ...
   *
   * @param groupId The id of the group who is allowed to use the access points
   * returned.
   * @param pSecurityContext security context
   *
  ...
  //</editor-fold>
  //<editor-fold defaultstate="collapsed" desc="get[Ingest|Download|TransferTaskContainer|AccessPoint]ById">
  /**
  ...
  public StagingAccessPointConfigurationWrapper getAccessPointById(long pId, SimpleRESTContext pSecurityContext) {
    ...
    return performGetStagingAccessPointConfiguration(RestClientUtils.encodeUrl(STAGING_ALL_ACCESS_POINTS_BY_ID, pId), null);
  }
//</editor-fold>
...
//</editor-fold>
  ...
  public IngestInformationWrapper createIngest(String objectId, String accessPoint) {
    return createIngest(objectId, accessPoint, null, null);
  }
   ...
   * @param objectId id of the object.
   * @param accessPoint AccessPoint for transfer.
   * @param groupId group name of the digital object.
   *
   * @return IngestInformationWrapper.
   */
  public IngestInformationWrapper createIngest(String objectId, String accessPoint, String groupId) {
    return createIngest(objectId, accessPoint, groupId, null);
  }
   ...
   * @return IngestInformationWrapper.
   */
  public IngestInformationWrapper createIngest(String objectId, String accessPoint, SimpleRESTContext pSecurityContext) {
    return createIngest(objectId, accessPoint, null, pSecurityContext);
  }
   ...
   * @return IngestInformationWrapper.
   */
  public IngestInformationWrapper createIngest(String objectId, String accessPoint, String groupId, SimpleRESTContext pSecurityContext) {
    IngestInformationWrapper returnValue;
    MultivaluedMap formParams;
  ...
  public DownloadInformationWrapper createDownload(String objectId, String accessPoint) {
    return createDownload(objectId, accessPoint, null, null);
  }
  ...
  public DownloadInformationWrapper createDownload(String objectId, String accessPoint, SimpleRESTContext pSecurityContext) {
    return createDownload(objectId, accessPoint, null, pSecurityContext);
  }
   ...
   * @param objectId id of the object.
   * @param accessPoint AccessPoint for transfer.
   * @param pGroupId The groupId the download should be associated with.
   * @param pSecurityContext The security context.
   *
   * @return An IngestInformationWrapper.
   */
  public DownloadInformationWrapper createDownload(String objectId, String accessPoint, String pGroupId, SimpleRESTContext pSecurityContext) {
    DownloadInformationWrapper returnValue;
    MultivaluedMap formParams;
    MultivaluedMap queryParams = null;
    setFilterFromContext(pSecurityContext);
