...
public interface ITransferInformationPersistence<C extends ITransferStatus, D extends ITransferInformation<C>> {
     ...
     */
    /**
     * Create and return a new entity. This call may throw any runtime
     * exception, e.g. PersistenceException if persisting the entity fails or
     ...
     *
     * @return The entity with the id pId or null, if there is no entity with
     * this id.
     */
    D getEntityById(long pId, IAuthorizationContext pSecurityContext);

    /**
     * Get all entities associated with a digital object id. The list may
     * contain exactly one entity (data ingest) or multiple entities (data
     * download) accessible by the context pSecurityContext.
     *
     ...
     *
     * @return A list of entities. In case of transfer operations there should
     * be only one result, for download there might be more.
     */
    ...
    /**
     * Get the number of entities for a specific digital object id. In case of
     * an ingest, this method should return 0 or 1, in case of a download any
     * value larger than 0 are possible.
     *
     * @param pDigitalObjectId The digital object id used to query for entities.
     * @param pSecurityContext The security context used to check access
     * permissions for this method and the ownership of the entity.
     *
     * @return The number of entities associated with the provided digital
     * object id.
     */
     ...
     * intended to be used for administrative purposes. By default, the user id
     * of the authorization context is used to determine the owner.
     *
    ...
    /**
     * Get the number of entities for a provided owner id. This method is
     * intended to be used for administrative purposes. By default, the user id
     * of the authorization context is used to determine the owner.
     *
     *
    ...
    /**
     * Get all entities that have expired (either because the expired field is
     * set to a concrete timestamp or the lastModification was too long ago).
     *
     * @param pMinIndex The first index that will be returned. Using an index
     * smaller or equal 0, we'll start with the first result.
     * @param pMaxResults The max. number of results starting at index pIndex.
    ...
    /**
     * Get a list of entities that can be handled by the according transfer
     * finalizer, e.g. ingest into archive or restoring into cache. The
     * selection of pMaxResults should be based on ordering the entities by
     * creation timestamp.
     *
     ...
     * permissions for this method and the ownership of the entity.
     *
     * @return A list of transferable entities.
     */
    List<D> getTransferableEntities(int pMaxResults, IAuthorizationContext pSecurityContext);
     ...
     * access URL either points to an URL where a transfer client was generated
     * if only a dedicated transfer client can be used to access data, or to a
     ...
     * points to the location were the data will be located physically. The
     * access can be done via the access URL (getAccessURL) either manually or
     * by using a transfer client. This call should be associated with a status
     * change, e.g., in case of data ingest the status should switch to
     * PRE_INGEST_SCHEDULED.
     *
     * @param pId The id of the transfer to update.
     ...
     * staging step. This method will only be available for the ingest as for
     * the download case the storage URL won't be changed or used. This method
     * is basically intended to be used for monitoring and rollback.
     *
     * @param pId The id of the transfer to update.
