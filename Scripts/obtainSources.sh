...
mvn install exec:java -Dexec.workingdir="/tmp/release_tmp/$VERSION/Utils" -Dexec.mainClass="edu.kit.dama.util.release.GenerateSourceRelease" -Dexec.args="KITDM /tmp/release_tmp/$VERSION /tmp/release_tmp/$VERSION/sources"
