...
public final class DataManagerSettings {
  ...
  /**
   * Perform the internal initialization by loading the properties from the URL
   * obtained from {@link #getConfigurationURL()}.
   */
  private void initialize() {
    LOGGER.debug("Initializing KIT Data Manager settings");
//    try{
//    LoggerContext loggerContext = ((ch.qos.logback.classic.Logger) LOGGER).getLoggerContext();
//    if (loggerContext != null) {
//      URL mainURL = ConfigurationWatchListUtil.getMainWatchURL(loggerContext);
//      LOGGER.debug("Using logback configuration from {}", mainURL);
//    } else {
//      LOGGER.debug("Unable to determine used logback configuration.");
//    }
//    }catch(Throwable t){
//      //ignore this...
//    }
  ...
  /**
   * Get KIT Data Manager configuration URL from one of the following sources in
   * the following order:
   * <ul>
   ...
   * absolute/relative paths to a file on disk. If no configuration was found, a
