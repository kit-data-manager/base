...
public class ZipUtilsTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        LOGGER.debug("Using source dir {}", srcDir);
        Path source = Paths.get(srcDir);
        LOGGER.debug("Using destination dir {}", baseDir);
        Path dest = Paths.get(baseDir);
        Files.createDirectories(dest);

        LOGGER.debug("Copying files from {} to {}", source, dest);
        ...
        LOGGER.debug("Using output dir {}", outputDir);
        File file = new File(outputDir);
        LOGGER.debug("Recreating output dir.");
    ...
    public void testZip_File() throws Exception {
        ...
        LOGGER.debug("Zipping directory {} to {}", inputDir, pZipOut);
        ...
        pZipOut.delete();
        Assert.assertFalse(pZipOut.exists());
        LOGGER.debug("testZip_File() done.");
    }
    ...
    /**
     * Delete file or directory. In case of directory all containing files and
     * directories will be removed also.
     *
